...
dataSource.setUrl("jdbc:mysql://localhost:3306/sprintigor?useTimezone=true&serverTimezone=UTC");
...
dataSource.setPassword("bandtec");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Usuario registro = consultarUsuario.get(0);
        
        String texto = String.format("Login efetuado com sucesso. Bem vindo(a), ", registro.getNickGame());
